...
// Tunable values for desktop GUI layout, theming, and the table view.
// Do not include this from StylusCore sources: it pulls in juce_graphics for
// juce::Colour, which is not part of the core's module set.
namespace Stylus::UIConstants
{
    // Window
